    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-mint-50 to-white dark:from-dark-bg dark:to-dark-card">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-semibold text-mint-900 dark:text-dark-text mb-2">Welcome Back</h2>
          <p className="text-mint-900/70 dark:text-dark-text-muted">Sign in to your account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-mint-900/70 dark:text-dark-text-muted">Remember me</span>
              </label>
              <Link
                to="/auth/forgot-password"
                className="text-sm text-mint-600 dark:text-mint-400 hover:text-mint-700 dark:hover:text-mint-300 font-medium"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <p className="text-center text-mint-900/70 dark:text-dark-text-muted">
              ...
              <Link to="/auth/signup" className="text-mint-600 dark:text-mint-400 hover:text-mint-700 dark:hover:text-mint-300 font-medium">
                Sign up
              </Link>
            </p>
          </form>
