...
export default function Button({
  ...
  const variants = {
    primary: "bg-mint-600 text-white hover:bg-mint-700 shadow-mint hover:shadow-mint-lg",
    secondary: "bg-white text-mint-600 border-2 border-mint-600 hover:bg-mint-50",
